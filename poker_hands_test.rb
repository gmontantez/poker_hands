...
class Poker_Hand_test < Minitest::Test
	...
	def test_pair_tie_kicker_card
		hand2 = ["Qs", "Qd", "5c", "2h","7s"]
		hand1 = ["Js", "8d", "7c", "Qh","Qs"]
	  	hands = {"hand1" => hand1,"hand2" => hand2}
		assert_equal("hand1 high card two kicker hand wins",hand_comparison(hands))
	end
	...
	def test_two_flushes
		hand1 = ["3s", "5s", "Js", "9s","7s"]
		hand2 = ["2s", "4s", "Ts", "8s","6s"]
		hands = {"hand1" => hand1,"hand2" => hand2}
		assert_equal("hand1 high card hand wins",hand_comparison(hands))
	end
...
##########################################
	...
	def test_hand_two_high_card
		...
		hands = {"hand1" => hand1,"hand2" => hand2}
		assert_equal("hand2 high card hand wins",hand_comparison(hands))
	end
	...
	def test_evaluate_hands
		hand1 = ["Td", "9s", "6c", "8s","7h"]
		hand2 = ["2d", "3d", "4s", "5d", "6d"]
		hands = {"hand1" => hand1,"hand2" => hand2}
		assert_equal("hand1 high card hand wins",hand_comparison(hands))
	end
    ...
    def test_hand_comparison_straight_tie_all_same_numbers
        hand1 = ["7h", "6c", "5d", "4s", "3d"]
        hand2 = ["7c", "6d", "5h", "4d", "3h"]
        hands = {"hand1" => hand1, "hand2" => hand2}
        assert_equal("it's a tie, split the pot",hand_comparison(hands))
    end
    ...
    def test_hand_comparison_one_pair_tie
        ...
        assert_equal("hand1 high card three kicker hand wins",look_at_tie(hand1,hand2))
    end
    ...
    def test_look_at_one_pair_kicker_card_hand1_winner
        ...
        assert_equal("hand1 high card hand wins",look_at_tie(hand1,hand2))
    end
    ...
    def test_look_at_tie_one_pair_tie_two_kicker_card_tie
    	...
    	assert_equal("hand1 high card last kicker hand wins",look_at_tie(hand1,hand2))
    end

    def test_look_at_tie_high_card_tie_kicker_card_ties
    	hand1 = ["3h", "4c", "5d", "7d", "Kc"]
    	hand2 = ["3s", "4d", "5c", "7h", "Ks"]
    	assert_equal("it's a tie, split the pot",look_at_tie(hand1,hand2))
    end
    ...
    def test_hand_comparison_one_pair_tie_two_kicker_card_tie
    	...
    	hand2 = ["2h", "4d", "5c", "7h", "7s"]
    	hands = {"hand1" => hand1, "hand2" => hand2}
    	assert_equal("hand1 high card last kicker hand wins",hand_comparison(hands))
    end
	...
	def test_look_at_tie_random_hand_test
		...
		assert_equal("hand2 high card kicker hand wins",look_at_tie(hand1,hand2))
	end

	def test_split_the_pot_two_pair_tie
		hand1 = ["7h", "7c", "5h", "5h", "2d"]
		hand2 = ["7d", "7s", "5d", "5s", "2d"]
		assert_equal("it's a tie, split the pot",look_at_tie(hand1,hand2))
	end

	def test_split_the_pot_one_pair_tie
		hand1 = ["7h", "7c", "6h", "5h", "2d"]
		hand2 = ["7d", "7s", "6d", "5s", "2d"]
		assert_equal("it's a tie, split the pot",look_at_tie(hand1,hand2))
	end

	def test_split_the_pot_high_card_tie
		hand1 = ["7h", "2c", "4h", "9h", "Td"]
		hand2 = ["7d", "2s", "4d", "9s", "Td"]
		assert_equal("it's a tie, split the pot",look_at_tie(hand1,hand2))
	end

	def test_random_hands_player_one_wins
    	hand1 = ["2h", "Ac", "Ts", "3h", "6c"] # 
    	hand2 = ["2c", "Ad", "Ks", "4d", "7s"] # 
        hands = {"hand1" => hand1, "hand2" => hand2}
    	assert_equal("hand2 high card kicker hand wins",hand_comparison(hands))
    end
